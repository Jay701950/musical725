...
import { Bold, Circle, Plus, Ruler, Type } from 'lucide-react';
...
export default function Toolbar({ editor, canEdit, onAddSlide, slideSize, onSlideSizeChange }) {
  ...
  return (
    <div className="toolbar" aria-label="문서 도구">
      ...
      <div className="size-controls" aria-label="슬라이드 크기">
        <Ruler size={18} />
